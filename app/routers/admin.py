...
async def approve_exchange(
    ...
    if request.to_currency == "GENSHIN":
        user.genshin_balance += request.received_amount
    elif request.to_currency == "HONKAI":
        user.honkai_balance += request.received_amount
    elif request.to_currency == "ZENLESS":
        user.zenless_balance += request.received_amount
